    ...
    namespace MurmurHashUtils
    {
      ...
      inline uint64_t load_bytes(const char* thePnt, int theNb) noexcept
      {
        ...
        switch (theNb)
        {
          case 7:
            aResult =
              (static_cast<uint64_t>(static_cast<unsigned char>(thePnt[6])) << 48) | aResult;
            [[fallthrough]];
          case 6:
            aResult =
              (static_cast<uint64_t>(static_cast<unsigned char>(thePnt[5])) << 40) | aResult;
            [[fallthrough]];
          case 5:
            aResult =
              (static_cast<uint64_t>(static_cast<unsigned char>(thePnt[4])) << 32) | aResult;
            [[fallthrough]];
          case 4:
            aResult =
              (static_cast<uint64_t>(static_cast<unsigned char>(thePnt[3])) << 24) | aResult;
            [[fallthrough]];
          case 3:
            aResult =
              (static_cast<uint64_t>(static_cast<unsigned char>(thePnt[2])) << 16) | aResult;
            [[fallthrough]];
          case 2:
