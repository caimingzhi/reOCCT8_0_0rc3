...
public:
  using SignalException = std::variant<std::monostate,
                                       System::os::OSD_SIGBUS,
                                       System::os::OSD_SIGHUP,
                                       System::os::OSD_SIGILL,
                                       System::os::OSD_SIGINT,
                                       System::os::OSD_SIGKILL,
                                       System::os::OSD_SIGQUIT,
                                       System::os::OSD_SIGSEGV,
                                       System::os::OSD_SIGSYS,
                                       System::os::OSD_Exception_ACCESS_VIOLATION,
                                       System::os::OSD_Exception_ARRAY_BOUNDS_EXCEEDED,
                                       System::os::OSD_Exception_ILLEGAL_INSTRUCTION,
                                       System::os::OSD_Exception_IN_PAGE_ERROR,
                                       System::os::OSD_Exception_INT_OVERFLOW,
                                       System::os::OSD_Exception_INVALID_DISPOSITION,
                                       System::os::OSD_Exception_NONCONTINUABLE_EXCEPTION,
                                       System::os::OSD_Exception_PRIV_INSTRUCTION,
                                       System::os::OSD_Exception_STACK_OVERFLOW,
                                       System::os::OSD_Exception_STATUS_NO_MEMORY,
