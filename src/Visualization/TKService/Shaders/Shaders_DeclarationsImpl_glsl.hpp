static const char Shaders_DeclarationsImpl_glsl[] =
  ...
  "  occPeelDepth.rg   = vec2 (THE_DEPTH_CLEAR_VALUE); // depth value always increases, so that "
  "MAX blend equation can be used\n"
  ...
  "uniform               vec4 occLightSources[THE_MAX_LIGHTS * 4]; //!< packed light sources "
  "parameters\n"
  "uniform THE_PREC_ENUM int occLightSourcesTypes[THE_MAX_LIGHTS]; //!< packed light sources "
  "types\n"
  "#endif\n"
  "\n"
