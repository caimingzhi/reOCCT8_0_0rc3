static const char Shaders_PBREnvBaking_fs[] =
  ...
  "uniform int   uCurrentLevel;        //!< current level of specular IBL map (ignored in case of "
  "diffuse map's processing)\n"
  "uniform float uEnvSolidAngleSource; //!< source solid angle sample computed from one edge's "
  "size of source environment map's zero mipmap level\n"
  "#endif\n"
  "\n"
