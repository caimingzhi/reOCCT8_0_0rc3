static const char Shaders_Declarations_glsl[] =
  ...
  "\n"
  "uniform mat4 occWorldViewMatrixInverseTranspose;  //!< Transpose of the inverse of the "
  "world-view  matrix\n"
  "uniform mat4 occProjectionMatrixInverseTranspose; //!< Transpose of the inverse of the "
  "projection  matrix\n"
  "uniform mat4 occModelWorldMatrixInverseTranspose; //!< Transpose of the inverse of the "
  "model-world matrix\n"
  "\n"
  "#if defined(THE_IS_PBR)\n"
  "uniform sampler2D   occEnvLUT;             //!< Environment Lookup Table\n"
  "uniform sampler2D   occDiffIBLMapSHCoeffs; //!< Packed diffuse (irradiance) IBL map's spherical "
  "harmonics coefficients\n"
  "uniform samplerCube occSpecIBLMap;         //!< Specular IBL map\n"
  "uniform int         occNbSpecIBLLevels;    //!< Number of mipmap levels used in occSpecIBLMap "
  "to store different roughness values maps\n"
  "\n"
  "vec3 occDiffIBLMap (in vec3 theNormal); //!< Unpacks spherical harmonics coefficients to "
  "diffuse IBL map's values\n"
  "#endif\n"
  "\n"
  ...
  "float occPBRMaterial_NormalizedRoughness(in bool theIsFront); //!< Normalized roughness "
  "coefficient\n"
  ...
  "uniform sampler2D occSamplerNormal;      //!< XYZ normal texture sampler with W==0 indicating "
  "no texture\n"
  ...
  "#endif\n"
  "\n"
  "uniform               vec4      occColor;              //!< color value (in case of disabled "
  "lighting)\n"
  "uniform THE_PREC_ENUM int       occDistinguishingMode; //!< Are front and back faces "
  "distinguished?\n"
  "uniform THE_PREC_ENUM int       occTextureEnable;      //!< Is texture enabled?\n"
  "uniform               vec4      occTexTrsf2d[2];       //!< 2D texture transformation "
  "parameters\n"
  "uniform               float     occPointSize;          //!< point size\n"
  "\n"
  "//! Parameters of blended order-independent transparency rendering algorithm\n"
  "uniform               int       occOitOutput;      //!< Enable bit for writing output color "
  "buffers for OIT (occFragColor, occFragCoverage)\n"
  "uniform               float     occOitDepthFactor; //!< Influence of the depth component to the "
  "coverage of the accumulated fragment\n"
  "uniform               float     occAlphaCutoff;    //!< alpha test cutoff value\n"
  "\n"
  "//! Parameters of clipping planes\n"
  "#if defined(THE_MAX_CLIP_PLANES) && (THE_MAX_CLIP_PLANES > 0)\n"
  "uniform               vec4 occClipPlaneEquations[THE_MAX_CLIP_PLANES];\n"
  "uniform THE_PREC_ENUM int  occClipPlaneChains[THE_MAX_CLIP_PLANES]; //! Indicating the number "
  "of planes in the Chain\n"
