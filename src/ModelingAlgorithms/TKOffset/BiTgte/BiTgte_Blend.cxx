...
occ::handle<Geom2d_Curve> BiTgte_Blend::PCurveOnFace1(const int) const
{
  occ::handle<Geom2d_Curve> C;
  return C;
}

occ::handle<Geom2d_Curve> BiTgte_Blend::PCurve1OnFillet(const int) const
{
  occ::handle<Geom2d_Curve> C;
  return C;
}

occ::handle<Geom2d_Curve> BiTgte_Blend::PCurveOnFace2(const int) const
{
  occ::handle<Geom2d_Curve> C;
  return C;
}

occ::handle<Geom2d_Curve> BiTgte_Blend::PCurve2OnFillet(const int) const
{
  occ::handle<Geom2d_Curve> C;
  return C;
}
