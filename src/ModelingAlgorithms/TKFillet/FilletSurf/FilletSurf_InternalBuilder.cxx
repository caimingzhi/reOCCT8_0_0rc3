...
static bool IntPlanEdge(occ::handle<::model::adapter::BRepAdaptor_Curve>& Ed,
                        const gp_Pln&                   P,
                        double&                         w,
                        const double                    tol3d)
{
                                 ...
                                 const double                     tol3d)
{
  ...
  Guide->D1(pelsp, P, V);
  gp_Pln                         pln(P, V);
  occ::handle<::model::adapter::BRepAdaptor_Curve> ed = new ::model::adapter::BRepAdaptor_Curve(Spine->CurrentElementarySpine(ind));
