...

{
  ...
  extrapol = std::abs(Pmax - Pdep) / 50.0;
...

{
  ...
  FuncInv.GetTolerance(toler, 0.1 * tolpoint3d);
                                                 ...
                                                 double&       NewParam) const
{
  ...
  gp_Pnt      PntOnSurf2  = Adaptor3d_HSurfaceTool::Value(AnotherSurf, theU, theV);
