...
void ChFi3d_FilBuilder::SimulSurf(occ::handle<ChFiDS_SurfData>&           Data,
                                  ...
                                  const occ::handle<Adaptor3d_TopolTool>& I1,
                                  const occ::handle<::model::adapter::BRepAdaptor_Curve2d>& PC1,
                                  const occ::handle<::model::adapter::BRepAdaptor_Surface>& HSref1,
                                  const occ::handle<::model::adapter::BRepAdaptor_Curve2d>& PCref1,
                                  bool&                                   Decroch1,
...
void ChFi3d_FilBuilder::SimulSurf(occ::handle<ChFiDS_SurfData>&           Data,
                                  ...
                                  const occ::handle<::model::adapter::BRepAdaptor_Surface>& HS2,
                                  const occ::handle<Adaptor3d_TopolTool>& I2,
                                  const occ::handle<::model::adapter::BRepAdaptor_Curve2d>& PC2,
                                  const occ::handle<::model::adapter::BRepAdaptor_Surface>& HSref2,
                                  const occ::handle<::model::adapter::BRepAdaptor_Curve2d>& PCref2,
                                  bool&                                   Decroch2,
                                  const double,
                                  const double       TolGuide,
                                  double&            First,
