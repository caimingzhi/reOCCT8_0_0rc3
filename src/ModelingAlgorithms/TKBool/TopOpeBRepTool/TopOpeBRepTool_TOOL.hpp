...
public:
  ...
  Standard_EXPORT static int OriinSor(const TopoDS_Shape& sub,
                                      const TopoDS_Shape& S,
                                      const bool          checkclo = false);

  Standard_EXPORT static int OriinSorclosed(const TopoDS_Shape& sub, const TopoDS_Shape& S);
  ...
  Standard_EXPORT static bool Nt(const gp_Pnt2d& uv, const TopoDS_Face& f, gp_Dir& normt);

  Standard_EXPORT static bool NggeomF(const gp_Pnt2d& uv, const TopoDS_Face& F, gp_Vec& ng);
  ...
  Standard_EXPORT static double Matter(const gp_Vec& d1, const gp_Vec& d2, const gp_Vec& ref);
  ...
  Standard_EXPORT static bool WireToFace(
    ...
    const NCollection_DataMap<TopoDS_Shape,
                              ...
                              TopTools_ShapeMapHasher>& mapWlow,
