...
#include <TopOpeBRepTool_defineG.hpp>
...
void TopOpeBRep_FacesFiller::ProcessRLine()
{
  ...
  for (; VPI.More(); VPI.Next())
  {
    ...
    int obRest = TopOpeBRepTool_TOOL::OnBoundary(parRest, Erest);
    int obOO   = TopOpeBRepTool_TOOL::OnBoundary(OOpar, OOE);
