...
void IntCurve_IntCurveCurveGen::Perform(const TheCurve& C, const double TolConf, const double Tol)
{
  IntRes2d_Domain D1;
                                        ...
                                        const double           Tol)
{
  ...
  if (nbi1 > 1 || nbi2 > 1)
  {
    ...
    InternalCompositePerform(C1, D1, 1, nbi1, Tab1, C2, D2, 1, nbi2, Tab2, TolConf, Tol, true);
    return;
  }
  else
  {
