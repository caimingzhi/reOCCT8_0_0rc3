...
int IntImp_ZerCSParFunc::NbVariables() const
{
  return 3;
}

int IntImp_ZerCSParFunc::NbEquations() const
{
  return 3;
}

bool IntImp_ZerCSParFunc::Value(const math_Vector& X, math_Vector& F)
{
...
bool IntImp_ZerCSParFunc::Derivatives(const math_Vector& X, math_Matrix& D)
{
  gp_Pnt Psurf, Pcurv;
  gp_Vec D1u, D1v, D1w;
...
bool IntImp_ZerCSParFunc::Values(const math_Vector& X, math_Vector& F, math_Matrix& D)
{
  gp_Pnt Psurf, Pcurv;
  gp_Vec D1u, D1v, D1w;
  ThePSurfaceTool::D1(surface, X(1), X(2), Psurf, D1u, D1v);
...
double IntImp_ZerCSParFunc::Root() const
{
  return f;
}
