...
int IntImp_ZerParFunc::NbVariables() const
{
  return 3;
}

int IntImp_ZerParFunc::NbEquations() const
{
  return 3;
}

bool IntImp_ZerParFunc::Value(const math_Vector& X, math_Vector& F)
{
...
bool IntImp_ZerParFunc::Derivatives(const math_Vector& X, math_Matrix& D)
{
...
bool IntImp_ZerParFunc::Values(const math_Vector& X, math_Vector& F, math_Matrix& D)
{
                                          ...
                                          math_Vector&                      Tolerance)
{
  ...
  double Incr1 = (BornSup(1) - BornInf(1)) * 0.01;
  double Incr2 = (BornSup(2) - BornInf(2)) * 0.01;
  double Incr3 = (BornSup(3) - BornInf(3)) * 0.01;
  BornInf(1) -= Incr1;
  BornSup(1) += Incr1;
  BornInf(2) -= Incr2;
  BornSup(2) += Incr2;
...
bool IntImp_ZerParFunc::IsTangent(const math_Vector&          UVap,
