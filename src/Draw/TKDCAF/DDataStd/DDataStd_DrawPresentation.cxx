...
bool DDataStd_DrawPresentation::BeforeUndo(const occ::handle<TDF_AttributeDelta>& AD, const bool)
{
...
bool DDataStd_DrawPresentation::AfterUndo(const occ::handle<TDF_AttributeDelta>& AD, const bool)
{
  occ::handle<DDataStd_DrawPresentation> Pme = this;
  occ::handle<DDataStd_DrawPresentation> Pdt =
    occ::down_cast<DDataStd_DrawPresentation>(AD->Attribute());
