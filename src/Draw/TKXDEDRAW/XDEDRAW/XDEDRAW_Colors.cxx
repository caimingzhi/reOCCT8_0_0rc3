...
{
  const System::os::OSD_Path aPath(thePath);
  if (!System::os::OSD_File(aPath).Exists())
  {
...
static int setColor(Draw_Interpretor&, int argc, const char** argv)
{
  ...
  if (aDoc.IsNull())
  {
    System::log::Message::SendFail() << "Syntax error: " << argv[1] << " is not a document";
    return 1;
  }
  ...
  if (aLabel.IsNull())
  {
    ...
    if (aShape.IsNull())
    {
      System::log::Message::SendFail() << "Syntax error: " << argv[2] << " is not a label nor shape";
      return 1;
    }
  }
...
static int getColor(Draw_Interpretor& di, int argc, const char** argv)
{
  ...
  if ((1.0 - aColor.Alpha()) < math::precision::Precision::Confusion())
  {
...
static int getShapeColor(Draw_Interpretor& di, int argc, const char** argv)
{
  ...
  if (aLabel.IsNull())
  {
    System::log::Message::SendFail() << "Syntax error: '" << argv[2] << "' label is not found in the document";
    return 1;
  }
  ...
  {
    System::log::Message::SendFail() << "Syntax error: unknown color type '" << argv[3] << "'";
    return 1;
  }
...
static int addColor(Draw_Interpretor& di, int argc, const char** argv)
{
  ...
  if (aNbParsed != argc - 2)
  {
    System::log::Message::SendFail() << "Syntax error at '" << argv[2] << "'";
    return 1;
  }
...
static int setVisibility(Draw_Interpretor&, int argc, const char** argv)
{
  ...
  if (aLabel.IsNull())
  {
    System::log::Message::SendFail() << "Syntax error: " << argv[2] << " is not a label not shape";
    return 1;
  }
  ...
  if (argc == 4)
  {
    ...
    {
      System::log::Message::SendFail() << "Syntax error: unknown argument '" << argv[3] << "'";
      return 1;
    }
  }
...
static int getStyledVisibility(Draw_Interpretor& di, int argc, const char** argv)
{
  ...
  if (aShape.IsNull())
  {
    System::log::Message::SendFail() << "Syntax error: " << argv[2] << " is not a shape";
    return 1;
  }
...
static int setStyledcolor(Draw_Interpretor&, int argc, const char** argv)
{
  ...
  {
    System::log::Message::SendFail() << "Error: cannot set color for the indicated component";
    return 1;
  }
  return 0;
}
...
static int XGetAllVisMaterials(Draw_Interpretor& theDI, int theNbArgs, const char** theArgVec)
{
  ...
  if (aDoc.IsNull())
  {
    System::log::Message::SendFail() << "Syntax error: " << theArgVec[1] << " is not a document";
    return 1;
  }
...
static int XGetVisMaterial(Draw_Interpretor& theDI, int theNbArgs, const char** theArgVec)
{
  ...
  else
  {
    ...
    if (aShapeLab.IsNull())
    {
      System::log::Message::SendFail() << "Syntax error: " << theArgVec[2] << " is not material nor shape";
      return 1;
    }
...
static int XRemoveVisMaterial(Draw_Interpretor&, int theNbArgs, const char** theArgVec)
{
  ...
  if (aMatLab.IsNull())
  {
    System::log::Message::SendFail() << "Syntax error: " << theArgVec[2] << " is not a material";
    return 1;
  }
...
static int XSetVisMaterial(Draw_Interpretor&, int theNbArgs, const char** theArgVec)
{
  ...
  if (aShapeLab.IsNull())
  {
    System::log::Message::SendFail() << "Syntax error: " << theArgVec[2] << " is not a label not shape";
    return 1;
  }
  ...
  if (theNbArgs == 4)
  {
    ...
    if (aMatLab.IsNull())
    {
      System::log::Message::SendFail() << "Syntax error: " << theArgVec[3] << " is not a material";
      return 1;
    }
  }
