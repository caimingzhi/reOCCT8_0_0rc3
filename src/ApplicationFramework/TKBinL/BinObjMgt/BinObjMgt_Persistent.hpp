...
#include <BinObjMgt_PChar.hpp>
#include <BinObjMgt_PByte.hpp>
#include <BinObjMgt_PExtChar.hpp>
#include <BinObjMgt_PInteger.hpp>
#include <BinObjMgt_PReal.hpp>
#include <BinObjMgt_PShortReal.hpp>
...
#include <BinObjMgt_Persistent_1.hpp>
