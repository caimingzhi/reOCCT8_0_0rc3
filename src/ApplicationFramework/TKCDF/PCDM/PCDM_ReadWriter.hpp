...
public:
  ...
  Standard_EXPORT virtual void WriteVersion(const occ::handle<app::storage::Storage_Data>& aData,
                                            const occ::handle<CDM_Document>& aDocument) const = 0;

  Standard_EXPORT virtual int ReadReferenceCounter(
    const TCollection_ExtendedString&     theFileName,
    const occ::handle<System::log::Message_Messenger>& theMsgDriver) const = 0;
  ...
  Standard_EXPORT static void Open(const occ::handle<app::storage::Storage_BaseDriver>& aDriver,
                                   const TCollection_ExtendedString&      aFileName,
  ...
  Standard_EXPORT static void WriteFileFormat(const occ::handle<app::storage::Storage_Data>& aData,
                                              const occ::handle<CDM_Document>& aDocument);
