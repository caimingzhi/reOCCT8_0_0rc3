...
bool Approx_ComputeLine::ComputeCurve(const MultiLine& Line, const int firstpt, const int lastpt)
{
...
void Approx_ComputeLine::SetDegrees(const int degreemin, const int degreemax)
{
  mydegremin = degreemin;
  mydegremax = degreemax;
}

void Approx_ComputeLine::SetTolerances(const double Tolerance3d, const double Tolerance2d)
{
  mytol3d = Tolerance3d;
  mytol2d = Tolerance2d;
}
...
void Approx_ComputeLine::Error(const int Index, double& tol3d, double& tol2d) const
{
