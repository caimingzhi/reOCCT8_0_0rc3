                                 ...
                                 const double       H)
{
  ...
  if (inter.IsParallel())
  {
    ...
    else if (std::abs(dist) < radius)
    {
      ...
      axey  = axec.Direction().XYZ().Crossed(normp);
                                 ...
                                 const double   Tol)
{
  ...
  static double EllipseLimit   = 1.0E+9;
  static double HyperbolaLimit = 2.0E+6;
