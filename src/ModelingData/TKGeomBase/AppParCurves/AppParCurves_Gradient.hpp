      ...
      MError2d(0.0)
{
  ...
  SCU                              = MyF.CurveValue();
  int                          deg = SCU.NbPoles() - 1;
  NCollection_Array1<gp_Pnt>   TabPole(1, deg + 1), TabCoef(1, deg + 1);
  NCollection_Array1<gp_Pnt2d> TabPole2d(1, deg + 1), TabCoef2d(1, deg + 1);
...
bool AppParCurves_Gradient::IsDone() const
{
  return Done;
}

double AppParCurves_Gradient::Error(const int Index) const
{
  return ParError(Index);
}

double AppParCurves_Gradient::AverageError() const
{
  return AvError;
}

double AppParCurves_Gradient::MaxError3d() const
{
  return MError3d;
}

double AppParCurves_Gradient::MaxError2d() const
{
  return MError2d;
}
