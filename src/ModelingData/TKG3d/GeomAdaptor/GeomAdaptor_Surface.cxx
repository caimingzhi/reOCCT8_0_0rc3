...
#include "../Geom/Geom_ExtrusionUtils.hpp"
#include "../Geom/Geom_OffsetSurfaceUtils.hpp"
#include "../Geom/Geom_RevolutionUtils.hpp"
...
occ::handle<Adaptor3d_Surface> GeomAdaptor_Surface::ShallowCopy() const
{
  ...
  else if (auto* anOffsetData = std::get_if<GeomAdaptor_Surface::OffsetData>(&mySurfaceData))
  {
    ...
    aNewData.OffsetSurface = anOffsetData->OffsetSurface;
