                                                 ...
                                                 IGESData_ParamReader& PR) const
{
  ...
  if (PR.DefinedElseSkip())
    ...
    PR.ReadInteger(PR.Current(), "Number of data fields", tempNbData);
  else
    tempNbData = 2;
  PR.ReadInteger(PR.Current(), "Type of attached associativity", tempType);
  PR.ReadText(PR.Current(), "Name of attached associativity", tempName);
...
void IGESBasic_ToolAssocGroupType::OwnShared(const occ::handle<IGESBasic_AssocGroupType>&,
...
IGESData_DirChecker IGESBasic_ToolAssocGroupType::DirChecker(
  const occ::handle<IGESBasic_AssocGroupType>&) const
{
