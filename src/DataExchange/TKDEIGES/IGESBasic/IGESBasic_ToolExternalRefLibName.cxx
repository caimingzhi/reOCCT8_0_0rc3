  ...
  IGESData_ParamReader& PR) const
{
  ...
  PR.ReadText(PR.Current(), "Name of Library", tempLibName);
...
void IGESBasic_ToolExternalRefLibName::OwnShared(const occ::handle<IGESBasic_ExternalRefLibName>&,
...
IGESData_DirChecker IGESBasic_ToolExternalRefLibName::DirChecker(
  const occ::handle<IGESBasic_ExternalRefLibName>&) const
{
...
void IGESBasic_ToolExternalRefLibName::OwnCheck(const occ::handle<IGESBasic_ExternalRefLibName>&,
