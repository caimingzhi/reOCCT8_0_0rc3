...
{ /* a page of parameters; see AddParam */
  struct parpage* next;
  int             used;
...
{
  curnumpart++;
  if (curnumpart >= curpage->used)
  { /* caution, addressing from 0 to used-1 */
    curpage    = curpage->next;
    curnumpart = 0;
  }
}
