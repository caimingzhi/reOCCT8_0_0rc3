        ...
        if (!Sh.IsNull())
        {
          if (Sh.ShapeType() == TopAbs_EDGE)
          {
            ...
            if (V1.IsSame(V2) || dist1f + dist2l <= dist1l + dist2f + Precision::Confusion())
            {
              ...
              B.UpdateVertex(V1, first, E, 0.);
              B.UpdateVertex(V2, last, E, 0.);
            ...
            else
            {
              ...
              B.UpdateVertex(V1, last, E, 0.);
              B.UpdateVertex(V2, first, E, 0.);
              B.Range(E, first, last);
            }
