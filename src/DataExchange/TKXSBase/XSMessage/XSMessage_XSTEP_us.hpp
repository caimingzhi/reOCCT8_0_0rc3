static const char XSMessage_XSTEP_us[] =
  ...
  "!\n"
  ".XSTEP_43\n"
  "Global Section (Parameter 8) : Single math::precision::Precision Magnitude parameter is incorrect (Expected "
  "positive Integer). Default value 38 taken.\n"
  "!\n"
  ".XSTEP_44\n"
  "Global Section (Parameter 9) : Single math::precision::Precision Significance parameter is incorrect (Expected "
  "positive Integer). Default value 6 taken.\n"
  "!\n"
  ".XSTEP_45\n"
  "Global Section (Parameter 10) : Double math::precision::Precision Magnitude parameter is incorrect (Expected "
  "positive Integer). Default value 308 taken.\n"
  "!\n"
  ".XSTEP_46\n"
  "Global Section (Parameter 11) : Double math::precision::Precision Significance parameter is incorrect (Expected "
  ...
  "!\n"
  ".IGES_3030\n"
  "Count	W/F	Type	Form	System::log::Message on IGES entity\n"
  "-----	---	----	----	----------------------\n"
  "!\n"
  ".IGES_3035\n"
  "On IGES entities (DE) :\n"
