...
public:
  ...
  Standard_HIDDEN void Share(const occ::handle<StepGeom_RationalBSplineCurve>& ent,
                             Interface_EntityIterator&                         iter) const;

  Standard_HIDDEN void Check(const occ::handle<StepGeom_RationalBSplineCurve>& ent,
