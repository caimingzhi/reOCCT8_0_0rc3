...
public:
  ...
  Standard_HIDDEN void Share(const occ::handle<StepGeom_BSplineCurveWithKnots>& ent,
                             Interface_EntityIterator&                          iter) const;

  Standard_HIDDEN void Check(const occ::handle<StepGeom_BSplineCurveWithKnots>& ent,
